import {getAllReports, getReportById, generateReport, generateResumePdf} from "../services/interview.api.js";
...
export const useInterview = () => {
    ...
    const generateResumePdfFromReport = async (reportId) => {
        setLoading(true)
        let response = null
        try{
